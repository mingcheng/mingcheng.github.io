...
以下这里是我的些信息，希望能够帮助您了解我。

## 🏠 基本信息

85 年生人，家乡宁波，毕业于 `浙江科技学院`，目前 `上海外国语大学` 在读，2008 年开始参加工作。目前在[蚂蚁集团](https://github.com/antgroup)任开源布道师，同时也是 [Apache 基金会](https://www.apache.org/)的会员。

曾就职于 `阿里巴巴(淘宝)`、`丁香园`、`网易`、`思否` 等公司和团队，有创业经验；先后从事研发、架构师、技术讲师、技术负责人、合伙人(GP)等岗位。技术栈方面，具有多年从事 Golang、Java 等技术栈的研发和架构经验，曾负责业务保障、技术选型、技术团队、项目管理等工作，先后多次负责从零搭建团队。

够熟练阅读英文技术文档和参与社区讨论，同时坚持长期阅读以及[写博客](https://www.gracecode.com/)和公众号分享自己拙见和心得。
...
作为 Apache PMC 参与 Apache 基金会 [Apache Answer 项目](https://answer.apache.org/)，负责代码审核以及新版本投票等项目研发和推进。
...
### 🎮 2016.2 - 2019.9 / 网易杭州科技有限公司 / 技术负责人、后端架构师

在网易期间主要职位为综合技术管理岗，职级 5-1，主要负责多个项目和平台的开发和管理工作，先后有：

- `网易美学` 任一级事业部门技术负责人，负责将近两百人数的技术团队搭建管理、技术选型、业务开发和团队对接等工作，保障了美学社区的正常业务迭代。美学项目累计注册用户达到千万级别，日活 DAU 将近百万，后美学项目组合并到云音乐事业部；
- `杭州研究院` 任资深研究员，进行内部孵化项目的技术、项目和团队管理、人员培养、开发规范输出、资源调度以及业务需求评审等工作；
- `网易严选` 任资深架构师 负责严选的中间件开发和平台框架发展和演进，引入和推广 Golang 技术栈和云原生技术。

### 💊 2011.6-2015.12 / 观澜网络科技有限公司（丁香园） / 大前端技术负责人

加入丁香园创业团队，为丁香园第 12 号员工。从零开始搭建团队，先后负责客户端、服务端等研发工作，实现 `丁香医生`、`用药助手` 等项目落地。

其中团队的多个应用包括 `丁香医生`、`用药助手`、`家庭用药` 等多次在 AppStore 医学类目榜单中名列前五，累计用户达到百万级别。

### 📦 2007.2-2011.5 / 淘宝(中国)软件有限公司 / PHP 开发、前端工程师

在 Taobao UED 部门前端架构组任职，主要负责网站业务以及相关工具开发、前端安全规范的制定以及前端委员会的筹建，参与 淘宝商城(天猫)、五彩石、淘江湖 等项目的开发工作。
